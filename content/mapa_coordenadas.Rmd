...
Para visualizar los **meteoritos en una región determinada** del globo debemos indicar las coordenadas tal y como se expuso previamente. Pongamos por ejemplo que nos interesa visualizar los **meteoritos caídos (fell) en Europa** podemos indicar los siguientes comandos:
...
# graficamos en un mapa de Europa
