...
Una vez hemos relizado la agrupación podemos **representar dichos conglomerados en un dendrograma**. Para ello tenemos diversas posibilidades utilizando la función `plot()` del paquete {graphics} con ligeras diferencias:
...
tanglegram(DNDvab01,DNDvab12,
           ...
           sub = paste("entanglement =", round(entanglement(dend_listvab), 0.8)),
           fast=TRUE)
...
De forma similar podemos comparar los dendrogramas realizados siguiendo el criterio de clasificación de conglomerados según la distancia promedio y según el criterio Ward de mínima varianza. El procedimiento sería similar al realizado en el punto previo. 
