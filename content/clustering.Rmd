...
fviz_dend(DNDvab01, k = 6, 
          ...
          rect_fill = TRUE)+
  labs(title = NULL, subtitle = "Dendrograma VAB de las regiones peruanas, 2001",
       caption = NULL, 
       x = NULL, 
       y = NULL, 
       fill = NULL) + 
...
fviz_dend(DNDvab12, k = 6, 
          ...
          rect_fill = TRUE)+
  labs(title = NULL, subtitle = "Dendrograma VAB de las regiones peruanas, 2012", 
       caption = NULL, 
       x = NULL, 
       #y = NULL, 
       fill = NULL) + 
