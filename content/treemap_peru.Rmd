...
### **1. ¿Qué peso tiene (en 2016) cada una de las economías regionales sobre el valor agregado bruto total de la economía peruana?**
...
### **2. ¿Qué peso tiene (en 2016) cada sector sobre el valor agregado total de la economía peruana en su conjunto?**
...
### **3. ¿Qué sectores a nivel regional contribuyen en mayor y en menor medida al VAB total de la economía peruana en 2016?** 
...
### **4. ¿Qué peso tiene (en 2016) cada sector sobre el VAB de cada región?**
...
### **5. ¿En qué medida contribuyen las regiones peruanas al VAB agregado de cada uno de los grandes sectores productivos en 2016?**
