...
Por último **realizamos el gráfico** utilizando `ggplot2` como hemos relizado previamente. Como ya se ha expuesto, podemos customizar nuestro grafico utilizando las funciones de dicho paquete. En el gráfico realizamos algunas modificaciones (color de fondo, tamaño del texto del título, subtítulo, leyenda, cambio en la posición de la leyenda, etc.) sobre el mapa previo para ejemplificar la forma en la que podemos aplicar dichas modificaciones a nuestro gusto.
...
riesgo_pobreza_grafico %>%
  ...
  geom_polygon(aes(fill=Riesgo_pobreza), color= "white") +
