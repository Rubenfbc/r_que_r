...
Como hemos podido comprobar a lo largo de este post, resulta sencillo poder integrar el lenguaje y las capacidades de R en esta nueva y potente herramienta de Microsoft. Compaginar R con Power Bi nos proporciona enormes posibilidades a la hora de analizar y visualizar datos y nos abre las puertas a nuevas posibilidades. Resulta, por tanto, muy conveniente dedicar tiempo a profundizar en las posibilidades que ofrecen cada una de estas herramientas y en aprender los mecanismos mediante los cuales podemos trabajar conjuntamente con ambos y sacar el máximo provecho de ellas.

\

El informe realizado a lo largo de este post puede ser visualizado utilizando Power Bi Server y compartido de diversas formas, también insertado en un sitio web como el actual. 
