...
A modo de ejemplo, podemos crear un dataset que muestre la evolución del número de muertes por infarto agudo de miocardio en España según datos del INE utilizando el icono del corazón presente en el dataset anterior.  
