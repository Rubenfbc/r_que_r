...
La función INTERSECT **devuelve aquellas observaciones que se ecuentren en ambos datasets**. Esta función se asemeja al INNER JOIN pero, recordemos, en este caso se requiere que ambos datasets estén conformados por las mismas columnas tal y como se observa en la figura siguiente.
