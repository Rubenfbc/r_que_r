...
**En R** podemos obtener el mismo resultado utilizando la función `filter()`, para seleccionr el año inicial y final, junto a la función `spread()` para generar las dos columnas, una para 1952 y otra para 2007, y la función `mutate()`para crear una nueva columna qune indique el crecimiento de la siguiente forma:
